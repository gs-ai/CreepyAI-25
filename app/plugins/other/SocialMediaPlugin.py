...
class SocialMediaPlugin(InputPlugin):
    ...
    def __init__(self):
        ...
        self.config_file = os.path.join(os.path.expanduser("~"), ".creepyai", "plugins", "social_media.json")
    ...
    def create_default_config(self):
        ...
        return {
            "api_keys": {},
            "cache_dir": os.path.join(os.path.expanduser("~"), ".creepyai", "cache", "social_media"),
            "max_results": 100,
            "timeout": 30
        }
    ...
    def configure(self):
        ...
        # Implementation would be provided by subclasses
        return True
        
    def run(self, query=None):
        """Run the plugin with the given query"""
        # Implementation would be provided by subclasses
