...
This module re-exports everything from ``app.plugins.run_plugin_cli`` so that
...
if __name__ == "__main__":
    _run_main()
from app.plugins.run_plugin_cli import *  # noqa: F401,F403
...
if __name__ == '__main__':
    _runpy.run_module('app.plugins.run_plugin_cli', run_name='__main__')
