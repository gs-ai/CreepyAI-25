...
This module re-exports everything from ``app.plugins.example_plugin`` so that
...
if __name__ == "__main__":
    _run_main()
from app.plugins.example_plugin import *  # noqa: F401,F403
...
if __name__ == '__main__':
    _runpy.run_module('app.plugins.example_plugin', run_name='__main__')
