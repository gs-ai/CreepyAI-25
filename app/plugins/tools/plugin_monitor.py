...
This module re-exports everything from ``app.plugins.plugin_monitor`` so that
...
if __name__ == "__main__":
    _run_main()
from app.plugins.plugin_monitor import *  # noqa: F401,F403
...
if __name__ == '__main__':
    _runpy.run_module('app.plugins.plugin_monitor', run_name='__main__')
