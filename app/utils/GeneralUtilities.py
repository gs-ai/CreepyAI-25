...
"""
General utilities for CreepyAI.
...
logger = logging.getLogger('creepyai.utilities.general')

class GeneralUtilities:
    """General utility functions for CreepyAI."""
    ...
    @staticmethod
    def format_timestamp(timestamp: Optional[Union[int, float, datetime.datetime]] = None) -> str:
